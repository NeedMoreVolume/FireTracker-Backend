...
// Server lists the log service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Create http.Handler
	Get    http.Handler
...
// New instantiates HTTP handlers for all the log service endpoints using the
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"CORS", "OPTIONS", "/log"},
			{"CORS", "OPTIONS", "/log/{id}"},
			{"CORS", "OPTIONS", "/log/list"},
			{"CORS", "OPTIONS", "/log/openapi.json"},
			{"./gen/http/openapi.json", "GET", "/log/openapi.json"},
		},
...
func (s *Server) Service() string { return "log" }
...
// Mount configures the mux to serve the log endpoints.
...
// MountCreateHandler configures the mux to serve the "log" service "create"
// endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := handleLogOrigin(h).(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
		}
	}
	mux.Handle("POST", "/log", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "log" service "create" endpoint.
...
// MountGetHandler configures the mux to serve the "log" service "get" endpoint.
...
// MountUpdateHandler configures the mux to serve the "log" service "update"
// endpoint.
...
// MountDeleteHandler configures the mux to serve the "log" service "delete"
// endpoint.
...
// MountListHandler configures the mux to serve the "log" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/log/list", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "log" service "list" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
func MountGenHTTPOpenapiJSON(mux goahttp.Muxer, h http.Handler) {
	mux.Handle("GET", "/log/openapi.json", handleLogOrigin(h).ServeHTTP)
}
...
func MountCORSHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("OPTIONS", "/log", f)
	mux.Handle("OPTIONS", "/log/{id}", f)
	mux.Handle("OPTIONS", "/log/list", f)
	mux.Handle("OPTIONS", "/log/openapi.json", f)
}
...
// handleLogOrigin applies the CORS response headers corresponding to the
// origin for the service log.
func handleLogOrigin(h http.Handler) http.Handler {
