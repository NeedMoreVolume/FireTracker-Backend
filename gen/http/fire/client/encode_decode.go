...
// marshalFireLogToLogRequestBody builds a value of type *LogRequestBody from a
// value of type *fire.Log.
func marshalFireLogToLogRequestBody(v *fire.Log) *LogRequestBody {
	if v == nil {
		return nil
	}
	res := &LogRequestBody{
	...
	if v.Weather != nil {
		res.Weather = marshalFireWeatherToWeatherRequestBody(v.Weather)
	}

	return res
}

// marshalFireWeatherToWeatherRequestBody builds a value of type
// *WeatherRequestBody from a value of type *fire.Weather.
func marshalFireWeatherToWeatherRequestBody(v *fire.Weather) *WeatherRequestBody {
	if v == nil {
		return nil
	}
	...
	if v.Temperature != nil {
		res.Temperature = marshalFireTemperatureToTemperatureRequestBody(v.Temperature)
	}
	if v.DewPoint != nil {
		res.DewPoint = marshalFireTemperatureToTemperatureRequestBody(v.DewPoint)
	}
	if v.Wind != nil {
		res.Wind = marshalFireWindToWindRequestBody(v.Wind)
	}

	return res
}

// marshalFireTemperatureToTemperatureRequestBody builds a value of type
// *TemperatureRequestBody from a value of type *fire.Temperature.
func marshalFireTemperatureToTemperatureRequestBody(v *fire.Temperature) *TemperatureRequestBody {
	if v == nil {
		return nil
	}
...
// marshalFireWindToWindRequestBody builds a value of type *WindRequestBody
// from a value of type *fire.Wind.
func marshalFireWindToWindRequestBody(v *fire.Wind) *WindRequestBody {
	if v == nil {
		return nil
	}
	res := &WindRequestBody{
...
// marshalLogRequestBodyToFireLog builds a value of type *fire.Log from a value
// of type *LogRequestBody.
func marshalLogRequestBodyToFireLog(v *LogRequestBody) *fire.Log {
	if v == nil {
		return nil
	}
	res := &fire.Log{
	...
	if v.Weather != nil {
		res.Weather = marshalWeatherRequestBodyToFireWeather(v.Weather)
	}

	return res
}

// marshalWeatherRequestBodyToFireWeather builds a value of type *fire.Weather
// from a value of type *WeatherRequestBody.
func marshalWeatherRequestBodyToFireWeather(v *WeatherRequestBody) *fire.Weather {
	if v == nil {
		return nil
	}
	res := &fire.Weather{
	...
	if v.Temperature != nil {
		res.Temperature = marshalTemperatureRequestBodyToFireTemperature(v.Temperature)
	}
	if v.DewPoint != nil {
		res.DewPoint = marshalTemperatureRequestBodyToFireTemperature(v.DewPoint)
	}
	if v.Wind != nil {
		res.Wind = marshalWindRequestBodyToFireWind(v.Wind)
	}

	return res
}

// marshalTemperatureRequestBodyToFireTemperature builds a value of type
// *fire.Temperature from a value of type *TemperatureRequestBody.
func marshalTemperatureRequestBodyToFireTemperature(v *TemperatureRequestBody) *fire.Temperature {
	if v == nil {
		return nil
	}
...
// marshalWindRequestBodyToFireWind builds a value of type *fire.Wind from a
// value of type *WindRequestBody.
func marshalWindRequestBodyToFireWind(v *WindRequestBody) *fire.Wind {
	if v == nil {
		return nil
	}
	res := &fire.Wind{
...
func unmarshalFireResponseBodyToFireFire(v *FireResponseBody) *fire.Fire {
	...
	if v.Logs != nil {
		res.Logs = make([]*fire.Log, len(v.Logs))
		for i, val := range v.Logs {
			res.Logs[i] = unmarshalLogResponseBodyToFireLog(val)
		}
	}
	if v.Weathers != nil {
		res.Weathers = make([]*fire.Weather, len(v.Weathers))
		for i, val := range v.Weathers {
			res.Weathers[i] = unmarshalWeatherResponseBodyToFireWeather(val)
		}
	}
